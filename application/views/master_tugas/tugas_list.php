                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>TAMBAH TUGAS</div>
								...
								<div class="module-body">
                                   <div class="row" style="margin-bottom: 10px">
										...
										<div class="col-md-4 text-right">
											<?php echo anchor(site_url('c_master_tugas/tambah'), 'Create', 'class="btn btn-primary"'); ?>
									</div>
									</div>
									...
									<tbody>
										<?php
										$start = 0;
										foreach ($c_master_tugas_data as $c_master_tugas)
										{
											?>
											<tr>
										<td><?php echo ++$start ?></td>
										<td><?php echo $c_master_tugas->ID_FASILITAS ?></td>
										<td><?php echo $c_master_tugas->JENIS_TUGAS ?></td>
										<td style="text-align:center" width="200px">
										<?php 
										echo anchor(site_url('c_master_tugas/read/'.$c_master_tugas->ID_TUGAS),'Read'); 
										echo ' | '; 
										echo anchor(site_url('c_master_tugas/update/'.$c_master_tugas->ID_TUGAS),'Update'); 
										echo ' | '; 
										echo anchor(site_url('c_master_tugas/delete/'.$c_master_tugas->ID_TUGAS),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
										?>
										</td>
										</tr>
											<?php
