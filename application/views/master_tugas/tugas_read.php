                        ...
                        <div class="content">
                            ...
                            <div class="module">
								...
								<div class="module-body">
									...
									<table class="table">
									<tr><td>ID FASILITAS</td><td><?php echo $ID_FASILITAS; ?></td></tr>
									<tr><td>JENIS TUGAS</td><td><?php echo $JENIS_TUGAS; ?></td></tr>
									<tr><td></td><td><a href="<?php echo site_url('c_master_tugas') ?>" class="btn btn-default">Cancel</a></td></tr>
								</table>
									</body>
