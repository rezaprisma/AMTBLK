                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Detail Barang</div>
								...
								<table class="table">
									...
									<tr><td>TANGGAL MASUK</td><td><?php echo $TANGGAL_TERIMA; ?></td></tr>
									...
									<tr><td></td><td><a href="<?php echo site_url('c_data_barang') ?>" class="btn btn-default">Cancel</a></td></tr>
								</table>
								</div> 
