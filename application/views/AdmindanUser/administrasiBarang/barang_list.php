                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Data Stok Barang Di Gudang</div>
                                ...
                                <div class="module-body">
                                  <div class="row" style="margin-bottom: 10px">
									...
									<div class="col-md-4 text-right">
										<?php echo anchor(site_url('c_data_barang/tambah'), 'Kirim Barang Ke Petugas', 'class="btn btn-primary"'); ?>
								</div>
								</div>
								...
								<tbody>
									<?php
									$start = 0;
									foreach ($c_data_barang_data as $c_data_barang)
									{
										?>
										<tr>
									<td><?php echo ++$start ?></td>
									<td><?php echo $c_data_barang->NO_BON ?></td>
									<td><?php echo $c_data_barang->NAMA_BARANG ?></td>
									
									<td><?php echo $c_data_barang->STATUS_BARANG ?></td>
									<td><?php echo $c_data_barang->TANGGAL_TERIMA ?></td>
									<td><?php echo $c_data_barang->LOKASI ?></td>
									<td><?php echo $c_data_barang->KONDISI ?></td>
									<td><?php echo $c_data_barang->jumlah ?></td>
									<td><?php echo $c_data_barang->SATUAN ?></td>
									<td style="text-align:center" width="200px">
									<?php 
									echo anchor(site_url('c_data_barang/read/'.$c_data_barang->NO_BON),' ', 'class="fa fa-eye fa-lg" aria-hidden="true"'); 
									//echo ' | '; 
									//echo anchor(site_url('c_data_barang/update/'.$c_data_barang->NO_BON),' ', 'span style="color: green;"class="fa fa-arrow-circle-right fa-lg" aria-hidden="true"'); 
									?>
									</td>
									</tr>
										<?php
