                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Data Barang Yang Telah Keluar dan Digunakan.</div>
								...
								<tbody>
									...
									<td><?php echo $c_data_barang_keluar->STATUS_BARANG ?></td>
									...
									<?php 
									echo anchor(site_url('c_data_barang_keluar/read/'.$c_data_barang_keluar->KODEBARCODE),' ','class="fa fa-eye fa-lg" aria-hidden="true"'); 
									?>
									</td>
									</tr>
										<?php
