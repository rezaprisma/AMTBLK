                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                ...
                                <div class="module-body">
									...
									<div class="col-md-4">
										<h2 style="margin-top:0px">Detail_pengadaan List</h2>
									</div>
									...
									<div class="col-md-4 text-right">
										<?php echo anchor(site_url('c_detail_pengadaan/create'), 'Create', 'class="btn btn-primary"'); ?>
								<?php echo anchor(site_url('c_detail_pengadaan/excel'), 'Excel', 'class="btn btn-primary"'); ?>
								</div>
								</div>
								...
								<tbody>
									<?php
									$start = 0;
									foreach ($c_detail_pengadaan_data as $c_detail_pengadaan)
									{
										?>
										<tr>
									<td><?php echo ++$start ?></td>
									<td><?php echo $c_detail_pengadaan->NAMA_BARANG ?></td>
									<td><?php echo $c_detail_pengadaan->MERK_BARANG ?></td>
									<td><?php echo $c_detail_pengadaan->JENIS_BARANG ?></td>
									<td><?php echo $c_detail_pengadaan->TIPE_BARANG ?></td>
									<td><?php echo $c_detail_pengadaan->JUMLAH_BARANG ?></td>
									<td><?php echo $c_detail_pengadaan->SATUAN ?></td>
									<td><?php echo $c_detail_pengadaan->KETERANGAN ?></td>
									<td style="text-align:center" width="200px">
									<?php 
									echo anchor(site_url('c_detail_pengadaan/read/'.$c_detail_pengadaan->ID_DETAIL),' ', 'class="fa fa-eye" aria-hidden="true"');
									?>
									</td>
									</tr>
										<?php
