                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Data Barang Yang Masuk Dari Supplier</div>
                                ...
                                <div class="module-body">
                                  <div class="row" style="margin-bottom: 10px">
									...
									<div class="col-md-4 text-right">
										<?php echo anchor(site_url('c_penerimaan_barang/create'), 'Create', 'class="btn btn-primary"'); ?>
								<?php echo anchor(site_url('c_penerimaan_barang/excel'), 'Excel', 'class="btn btn-primary"'); ?>
								</div>
								</div>
								...
								<tbody>
									<?php
									$start = 0;
									foreach ($c_penerimaan_barang_data as $c_penerimaan_barang)
									{
										?>
										<tr>
									<td><?php echo ++$start ?></td>
									<td><?php echo $c_penerimaan_barang->NO_BON ?></td>
									<td><?php echo $c_penerimaan_barang->ID_PENGADAAN ?></td>
									<td><?php echo $c_penerimaan_barang->NAMA_BARANG ?></td>
									<td><?php echo $c_penerimaan_barang->TANGGAL_TERIMA ?></td>
									<td><?php echo $c_penerimaan_barang->JUMLAH_BARANG ?></td>
									<td><?php echo $c_penerimaan_barang->SATUAN ?></td>
									<td><?php echo $c_penerimaan_barang->KONDISI ?></td>
									<td><?php echo $c_penerimaan_barang->NAMA_SUPPLIER ?></td>
									<td style="text-align:center" width="200px">
									<?php 
									echo anchor(site_url('c_penerimaan_barang/read/'.$c_penerimaan_barang->NO_BON),' ', 'class="fa fa-eye" aria-hidden="true"'); 
									?>
									</td>
									</tr>
										<?php
								...
								<h6>&nbsp; *Data barang yang masuk adalah data barang satuan kecil</h6>
                                </div>
                            </div>
                            <!--/.module-->
