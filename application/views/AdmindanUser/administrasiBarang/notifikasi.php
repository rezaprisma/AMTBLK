                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                ...
                                <div class="module-body">
                                  <div class="row" style="margin-bottom: 10px">
									...
									<div class="col-md-4 text-right">
										<?php echo anchor(site_url('c_data_barang/create'), 'Create', 'class="btn btn-primary"'); ?>
								</div>
								</div>
								...
								<tbody>
									...
									<td><?php echo $c_data_barang->TANGGAL_MASUK ?></td>
									<td><?php echo $c_data_barang->LOKASI ?></td>
									<td><?php echo $c_data_barang->TANGGAL_KELUAR ?></td>
									<td><?php echo $c_data_barang->KONDISI ?></td>
									<td style="text-align:center" width="200px">
									<?php 
									echo anchor(site_url('c_data_barang/read/'.$c_data_barang->KODEBARCODE),'Read'); 
									echo ' | '; 
									echo anchor(site_url('c_data_barang/update/'.$c_data_barang->KODEBARCODE),'Update'); 
									echo ' | '; 
									echo anchor(site_url('c_data_barang/delete/'.$c_data_barang->KODEBARCODE),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
									?>
									</td>
									</tr>
										<?php
