                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Data Laporan Kejadian</div>
								...
								<div class="module-body">
									...
									<tbody>
										...
										<?php 
										echo anchor(site_url('c_kepegawaian/read3/'.$petugas_security->id_laporan),' ', 'class="fa fa-eye" aria-hidden="true"');
										echo ' | '; 
										echo anchor(site_url('c_kepegawaian/delete3/'.$petugas_security->id_laporan),' ', 'class="fa fa-trash-o" aria-hidden="true"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
										?>
										</td>
										</tr>
											<?php
