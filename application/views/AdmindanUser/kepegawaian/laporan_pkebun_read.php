                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Detail Penugasan Petugas Kebun</div>
								...
								<div class="module-body">
									...
									<table class="table">
										...
										<tr><td>NAMA LOKASI</td><td><?php echo $ID_RUANGAN; ?></td></tr>
										<tr><td>KETERANGAN</td><td><?php echo $STATUS_PENUGASAN; ?></td></tr>
										<tr><td></td><td><a href="<?php echo site_url('c_kepegawaian/laporan1') ?>" class="btn btn-default">Cancel</a></td></tr>
									</table>
