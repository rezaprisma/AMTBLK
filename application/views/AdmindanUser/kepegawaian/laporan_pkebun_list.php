                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Data Penugasan Petugas Kebun</div>
								...
								<div class="module-body">
                                    <div class="row" style="margin-bottom: 10px">
										...
										<div class="col-md-4 text-right">
											<?php echo anchor(site_url('c_kepegawaian/tambah1'), 'Create', 'class="btn btn-primary"'); ?>
									</div>
									</div>
									...
									<tbody>
										...
										<?php 
										echo anchor(site_url('c_kepegawaian/read1/'.$petugas_kebun->ID_LAPORAN),'Detail', 'class="fa fa-arrow-circle-down" aria-hidden="true" class="fa fa-arrow-circle-down" aria-hidden="true"');
										?>
										</td>
										</tr>
											<?php
