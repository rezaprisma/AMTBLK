								...
								<div class="module-body">
                                    <div class="row" style="margin-bottom: 10px">
										...
										<div class="col-md-4 text-right">
											<?php echo anchor(site_url('c_kepegawaian/tambah'), 'Tambah Tugas', 'class="btn btn-primary"'); ?>
									</div>
									</div>
									...
									<tbody>
										...
										<?php 
										echo anchor(site_url('c_kepegawaian/read2/'.$cleaning_service->ID_LAPORAN),'Detail', 'class="fa fa-arrow-circle-down" aria-hidden="true" class="fa fa-arrow-circle-down" aria-hidden="true"');
										?>
										</td>
										</tr>
											<?php
