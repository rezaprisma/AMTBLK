                            ...
                            <div class="module">
								...
								<div class="module-body">
                                    <div class="row" style="margin-bottom: 10px">
										<div class="col-md-4 text-center">
											<div style="margin-top: 5px"  id="message">
												...
												<?php echo anchor(site_url('c_kepegawaian/excel'), 'Excel', 'class="btn btn-primary"'); ?>
											</div>
										</div>
									</div>
									<label for="varchar">Pilih Tanggal Laporan : <?php echo form_error('DATE_LPLK') ?></label>
										<input type="date" class="form-control" name="DATE_LPLK" id="DATE_LPLK" placeholder="DATE LPLK" value="<?php date_default_timezone_set("Asia/Jakarta"); echo date('m-d-Y')?>"/>
									
									<table class="table table-bordered table-striped" id="ytable">
									...
									<tbody>
										...
										<?php 
										echo anchor(site_url('c_kepegawaian/read2/'.$cleaning_service->ID_LAPORAN),' ', 'class="fa fa-eye fa-lg" aria-hidden="true" class="fa fa-arrow-circle-down" aria-hidden="true"');
										?>
										</td>
										</tr>
											<?php
