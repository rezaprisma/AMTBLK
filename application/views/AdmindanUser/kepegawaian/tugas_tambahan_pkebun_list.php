								...
								<div class="module-body">
                                    <div class="row" style="margin-bottom: 10px">
										...
										<div class="col-md-4 text-right">
											<?php echo anchor(site_url('c_kepegawaian/t_tambahan1'), 'Create', 'class="btn btn-primary"'); ?>
									</div>
									</div>
									...
									<tbody>
										...
										<?php 
										echo anchor(site_url('c_kepegawaian/read1/'.$petugas_kebun->ID_LAPORAN),' ', 'class="fa fa-eye" aria-hidden="true"');
										?>
										</td>
										</tr>
											<?php
