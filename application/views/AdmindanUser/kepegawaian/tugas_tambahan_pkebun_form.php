                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Input Penugasan Petugas Kebun</div>
								...
								<div class="module-body">
                                    <div class="panel-body">
											...
											echo validation_errors();
												...
												<form role="form" class="form-horizontal" method="POST" role="form" class="form-horizontal" action="<?php echo base_url();?>c_kepegawaian/tambah1/">
												...
												<div class="form-group">
													...
													<div class="col-sm-3">
													<?php
													$setting_user_group=array('type'=>'hidden','name'=>'user_group','class'=>'form-control input-sm','placeholder'=>'user_group','size'=>'4', 'value'=>'KEBUN');
												...
												<div class="form-group">
													...
													echo form_dropdown('id_ruangan',$id_lokasi,'',$style_ruangan);
													?>
												</div>
												</div>
												</br>
												...
												<div class="form-group">
													...
													<div class="col-sm-3">
													<?php
													$setting_status_keterangan=array('type'=>'hidden','name'=>'keterangan_tugas','class'=>'form-control input-sm','placeholder'=>'keterangan_tugas','size'=>'4', 'value'=>'Tugas Tambahan');
										...
										function tampilFasilitas()
										 {
											 ...
											 $.ajax({
												 url:"<?php echo base_url();?>c_kepegawaian/pilih_fasilitas1/"+kdfasilitas+"",
										 ...
										 function tampilTugas()
										 {
											 ...
											 $.ajax({
												 url:"<?php echo  base_url();?>c_kepegawaian/pilih_tugas1/"+kdtugas+"",
												 success: function(response){
										 ...
										 function tampilNIK()
										 {
											 ...
											 $.ajax({
												 url:"<?php echo  base_url();?>c_kepegawaian/pilih_NIK1/"+kdName+"",
												 success: function(response){
												 $("#NIK").html(response);
												 },
												 dataType:"html"
