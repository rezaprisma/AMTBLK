								...
								<div class="module-body">
                                    <div class="row" style="margin-bottom: 10px">
										...
										<div class="col-md-4 text-right">
											<?php echo anchor(site_url('c_kepegawaian/t_tambahan'), 'Tambah Tugas', 'class="btn btn-primary"'); ?>
									</div>
									</div>
									...
									<tbody>
										...
										<?php 
										echo anchor(site_url('c_kepegawaian/read2/'.$cleaning_service->ID_LAPORAN),' ', 'class="fa fa-eye" aria-hidden="true"');
										echo ' | '; 
										echo anchor(site_url('c_kepegawaian/update2/'.$cleaning_service->ID_LAPORAN),' ', 'class="fa fa-pencil-square-o" aria-hidden="true"'); 
										echo ' | '; 
										echo anchor(site_url('c_kepegawaian/delete2/'.$cleaning_service->ID_LAPORAN),' ', 'class="fa fa-trash-o" aria-hidden="true"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
										?>
										</td>
										</tr>
											<?php
