                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>ACC Tugas Petugas Cleaning Service</div>
								...
								<div class="module-body">
									...
									<tbody>
										...
										<?php 
										echo anchor(site_url('c_kepegawaian/update2/'.$cleaning_service->ID_LAPORAN),'ACC ', 'class="btn btn-lg btn-success"'); 
										?>
										</td>
										</tr>
											<?php
