            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="<?=base_url('/c_kepegawaian/back/')?>">AMTBLK </a>
                        ...
                        <div class="content">
							<div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="<?=site_url('/c_kepegawaian/ACC_kebun/')?>" class="btn-box big span4"><i class=" fa fa-pagelines"></i><b><?php
									if($jumlah!=null){
										...
										?></b>
                                        <p class="text-muted">
                                            Laporan Tugas Masuk Petugas Kebun</p>
                                    </a><a href="<?=site_url('/c_kepegawaian/ACC/')?>" class="btn-box big span4"><i class="icon-user"></i><b><?php
									if($jumlah_CS!=null){
										foreach ($jumlah_CS as $data)
										{
										...
										?></b>
                                        <p class="text-muted">
                                            Laporan Tugas Masuk Petugas CS</p>
                                    </a><a href="<?=site_url('/c_kepegawaian/laporan3/')?>" class="btn-box big span4"><i class="fa fa-shield"></i><b><?php
									if($jumlah_SC!=null){
										foreach ($jumlah_SC as $data)
										{
										...
										?></b>
                                        <p class="text-muted">
                                            Laporan Kejadian Petugas Security</p>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>PELAPORAN PETUGAS CLEANING SERVICE</div>
                                ...
                                <div class="module-body">
                                   <table class="table table-bordered table-striped" id="mytable">
										...
										<th>TUGAS YANG TERSELESAIAKN</th>
										<th>PERSEN TERSELESAIKAN</th>
											</tr>
										</thead>
									<tbody>
										<?php
										$start = 0;
										foreach ($jumlah_CS_pngs as $data)
										{
										foreach ($cleaning_service_data as $cleaning_service){
										if($data->LAST_NAME == $cleaning_service->LAST_NAME){
											?>
											<tr>
										...
										<td><?php echo ($cleaning_service->jumlah_CS_terselesaikan)?>/<?php
											if($data->jumlah_CS_pngs!=null){
												echo $data->jumlah_CS_pngs; 
											}else{
												echo 0;
											}
										...
										?></td>
										<td><?php echo ($cleaning_service->jumlah_CS_terselesaikan/$data->jumlah_CS_pngs)*100 ?>%</td>
										</tr>
											<?php
										}
										}
								...
								<h6>&nbsp; *Persen data yang masuk adalah hasil penugasan yang telah diselesaikan oleh petugas cleaning service</h6>
                            </div>
							
							<div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>PELAPORAN PETUGAS KEBUN</div>
										<div class="muted pull-right"><i class="icon-time"></i>&nbsp;
											<span id=tick2>			
												<script>
													function show2(){
								...
								<div class="module-body table">
									...
									<tbody>
										<?php
										$start = 0;
										foreach ($jumlah_kebun_pngs as $data)
										{
										foreach ($Petugas_kebun_data as $Petugas_kebun){
										if($data->LAST_NAME == $Petugas_kebun->LAST_NAME){
											?>
											<tr>
										<td><?php echo ++$start ?></td>
										...
										<td><?php echo $Petugas_kebun->jumlah_kebun_terselesaikan ?>/<?php
											if($data->jumlah_kebun_pngs!=null){
												echo $data->jumlah_kebun_pngs; 
											}else{
												echo 0;
											}
										...
										?></td>
										<td><?php echo ($Petugas_kebun->jumlah_kebun_terselesaikan/$data->jumlah_kebun_pngs)*100 ?>%</td>
										</tr>
											<?php
										}
										}
								...
								<h6>&nbsp; *Persen data laporan yang masuk adalah hasil penugasan yang telah diselesaikan oleh petugas kebun</h6>
                            </div>
