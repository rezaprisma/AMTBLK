                            ...
                            <div class="module">
                                <div class="module-head">
                                    <div class="navbar navbar-inner block-header">
										<div class="muted pull-left"><i class="icon-dashboard">&nbsp;</i>Detail Laporan Kejadian</div>
                                ...
                                <div class="module-body">
									...
									<table class="table">
										...
										<tr><td></td><td><a href="<?php echo site_url('c_kepegawaian/laporan3') ?>" class="btn btn-default">Cancel</a></td></tr>
									</table>
