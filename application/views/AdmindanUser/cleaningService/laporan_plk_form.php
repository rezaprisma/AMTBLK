                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                ...
                                <div class="module-body">
                                    <h2 style="margin-top:0px">Apakah Anda <?php echo $button ?> Telah Menyelesaikan Tugas ini? </h2>
								<form action="<?php echo $action; ?>" method="post">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="STATUS_ACC" id="STATUS_ACC" placeholder="STATUS_ACC" value="<?=set_value('STATUS_ACC', 'Belum ACC');?>" readonly='readonly'/>
									</div>
									<div class="form-group">
									...
									<a href="<?php echo site_url('cleaning_service/create/') ?>" class="btn btn-default">Cancel</a>
								</form>
