                        ...
                        <div class="content">
                            ...
                            <div class="module">
								...
								<tbody>
									<?php
									$start = 0;
									foreach ($c_data_barang_data as $c_data_barang_keluar)
									{
										?>
										<tr>
									<td><?php echo ++$start ?></td>
									<td><?php echo $c_data_barang_keluar->KODEBARCODE ?></td>
									<td><?php echo $c_data_barang_keluar->NAMA_BARANG ?></td>
									<td><?php echo $c_data_barang_keluar->JUMLAH_BARANG ?></td>
									<td><?php echo $c_data_barang_keluar->SATUAN ?></td>
									<td><?php echo $c_data_barang_keluar->LOKASI ?></td>
									<td><?php echo $c_data_barang_keluar->TANGGAL_KELUAR ?></td>
									<td><?php echo $c_data_barang_keluar->KONDISI ?></td>
									<td style="text-align:center" width="200px">
									<?php 
									echo anchor(site_url('Cleaning_service/read2/'.$c_data_barang_keluar->KODEBARCODE),' ', 'class="fa fa-eye fa-lg" aria-hidden="true"'); 
									echo ' | '; 
									echo anchor(site_url('Cleaning_service/update2/'.$c_data_barang_keluar->KODEBARCODE),' ','span style="color: green;"class="fa fa-arrow-circle-right fa-lg" aria-hidden="true"');
									?>
									</td>
									</tr>
										<?php
