                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
                                    <h3>DATA PENUGASAN YANG TELAH DI ACC</h3>
                                </div>
                               <div class="module-body">
									...
									<h3>DATA LAPORAN PENUGASAN YANG TELAH DI ACC</h3>
									...
									<tbody>
										...
										<td><?php echo $cleaning_service->ID_RUANGAN ?></td>
										<td><?php echo $cleaning_service->ID_FASILITAS ?></td>
										<td><?php echo $cleaning_service->ID_TUGAS ?></td>
