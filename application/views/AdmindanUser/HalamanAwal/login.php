					...
					<div class="title_index">
						<div class="row-fluid">
							<div class="span12"></div>
								<div class="row-fluid">
									<div class="span10">
										<img class="index_logo" src="<?php echo base_url('/PAku/AMTBLK/assets/tampilan/images/kk.png')?>">
							...
							<div class="nav-collapse collapse">
								<ul class="nav" id="footer_nav">
								  <li class="divider-vertical"></li>
									  ...
									  <li class="divider-vertical"></li>
									  <li><a href="<?=base_url('/PAku/AMTBLK/application/views/HalamanAwal/about.php/')?>"><i class="icon-info-sign"></i>&nbsp;About</a></li>						
									  <li class="divider-vertical"></li>
