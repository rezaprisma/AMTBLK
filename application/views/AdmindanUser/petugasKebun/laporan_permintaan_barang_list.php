                        ...
                        <div class="content">
                            ...
                            <div class="module">
								...
								<tbody>
									<?php
									$start = 0;
									foreach ($c_permintaan_barang_data as $c_permintaan_barang)
									{
										?>
										<tr>
									<td><?php echo ++$start ?></td>
									<td><?php echo $c_permintaan_barang->KODEBARCODE ?></td>
									<td><?php echo $c_permintaan_barang->USER_GROUP ?></td>
									<td><?php echo $c_permintaan_barang->NAMA_BARANG ?></td>
									<td><?php echo $c_permintaan_barang->STATUS_BARANG ?></td>
									<td><?php echo $c_permintaan_barang->TANGGAL_KELUAR ?></td>
									<td><?php echo $c_permintaan_barang->LOKASI ?></td>
									<td><?php echo $c_permintaan_barang->KONDISI ?></td>
									<td style="text-align:center" width="200px">
									<?php 
									echo anchor(site_url('Petugas_kebun/read2/'.$c_permintaan_barang->KODEBARCODE),' ','span style="color: red;" class="fa fa-times-circle fa-2x" aria-hidden="true"'); 
									?>
									</td>
									</tr>
										<?php
