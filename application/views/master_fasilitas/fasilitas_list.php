                            ...
                            <div class="module">
								...
								<div class="module-body">
									...
									<div class="col-md-4 text-right">
										<?php echo anchor(site_url('c_master_fasilitas/create'), 'Create', 'class="btn btn-primary"'); ?>
								</div>
								</div>
								...
								<tbody>
									<?php
									$start = 0;
									foreach ($c_master_fasilitas_data as $c_master_fasilitas)
									{
										?>
										<tr>
									<td><?php echo ++$start ?></td>
									<td><?php echo $c_master_fasilitas->NAMA_RUANGAN ?></td>
									<td><?php echo $c_master_fasilitas->FASILITAS ?></td>
									<td style="text-align:center" width="200px">
									<?php 
									echo anchor(site_url('c_master_fasilitas/read/'.$c_master_fasilitas->ID_FASILITAS),'Read'); 
									echo ' | '; 
									echo anchor(site_url('c_master_fasilitas/update/'.$c_master_fasilitas->ID_FASILITAS),'Update'); 
									echo ' | '; 
									echo anchor(site_url('c_master_fasilitas/delete/'.$c_master_fasilitas->ID_FASILITAS),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
									?>
									</td>
									</tr>
										<?php
