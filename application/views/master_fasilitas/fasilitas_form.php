                            ...
                            <div class="module">
								...
								<div class="module-body">
									...
									<div class="form-group">
													...
													<?php
													$style_ruangan='class="form-control input-sm" id="ID_RUANGAN"';
													echo form_dropdown('ID_RUANGAN',$ID_RUANGAN,'',$style_ruangan);
													?>
									</div>
									<div class="form-group">
									...
									<a href="<?php echo site_url('c_master_fasilitas') ?>" class="btn btn-default">Cancel</a>
								</form>		   
                                </div>
                            </div>
