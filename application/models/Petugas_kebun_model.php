...
class Petugas_kebun_model extends CI_Model
{
    ...
    {
		$this->db->select('laporan_plk.*,count(ID_LAPORAN) AS jumlah_kebun_terselesaikan, lokasikerja_pkebun.NAMA_LOKASI, fasilitaslokasi_pkebun.FASILITAS, tugas_pkebun.JENIS_TUGAS, users.LAST_NAME');
		$this->db->from('laporan_plk');
		$this->db->join('lokasikerja_pkebun','laporan_plk.ID_RUANGAN=lokasikerja_pkebun.ID_LOKASI','');
		$this->db->join('fasilitaslokasi_pkebun','laporan_plk.ID_FASILITAS=fasilitaslokasi_pkebun.ID_FASILITAS','');
		$this->db->join('tugas_pkebun','laporan_plk.ID_TUGAS=tugas_pkebun.ID_TUGAS','');
	...
	function get_pngs_kebun()
    {
		$this->db->select('laporan_plk.*,count(ID_LAPORAN) AS jumlah_kebun_pngs, lokasikerja_pkebun.NAMA_LOKASI, fasilitaslokasi_pkebun.FASILITAS, tugas_pkebun.JENIS_TUGAS, users.LAST_NAME');
		$this->db->from('laporan_plk');
		$this->db->join('lokasikerja_pkebun','laporan_plk.ID_RUANGAN=lokasikerja_pkebun.ID_LOKASI','');
		$this->db->join('fasilitaslokasi_pkebun','laporan_plk.ID_FASILITAS=fasilitaslokasi_pkebun.ID_FASILITAS','');
		$this->db->join('tugas_pkebun','laporan_plk.ID_TUGAS=tugas_pkebun.ID_TUGAS','');
